...
class FaceEyeDetectionApp:
    ...
    def create_widgets(self):
        ...
        # Define colors
        self.bg_color = "#d3d3d3"  # Light grey background
        self.btn_color = "#a9a9a9"  # Grey button background
        self.text_color = "#000000"  # Black text color
        self.frame_color = "#d3d3d3"  # Light grey frame background
        self.canvas_color = "#ffffff"  # White canvas background

        self.root.configure(bg=self.bg_color)

        # Create main frames
        left_frame = tk.Frame(self.root, width=200, padx=10, pady=10, bg=self.frame_color, relief=tk.RIDGE,
                              borderwidth=2)
    ...
    def upload_video(self):
        ...
        if self.video_path:
            ...
            if fps <= 0:
                fps = 40
            self.frame_delay = int(1000 / (fps * 6.5))
                ...
                for face in faces:
                    ...
                    if self.sunglasses_check_var.get():
                        ...
                        if sunglasses_detected:
                            self.log_message("Warning! Take sunglasses off!!!")
